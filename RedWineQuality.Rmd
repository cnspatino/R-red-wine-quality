...
# create quality factor variable
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# scale free sulfur dioxide by log10
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# scale total sulfur dioxide by log10
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# split dataset into high and low quality subsets
high_quality <- subset(wine, quality == 7 | quality == 8)
low_quality <- subset(wine, quality == 3 | quality == 4)

# plot high quality vs low quality histograms
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# plot boxplot of volatile acidity vs. quality factor
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# plot boxplot of alcohol vs. quality factor
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# plot boxplot of citric acid vs. quality factor
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# plot boxplot of sulphates vs. quality factor
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# plot boxplots of total and free sulfur dioxide vs. quality factor
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# create scatter plots of free and total sulfur dioxide vs. sulphates
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# create scatter plot of fixed acidity vs. citric acid
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# create scatter plot of volatile acidity vs. citric acid
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# create scatter plot of pH vs. fixed acidity
ggplot(aes(x=fixed.acidity, y=pH), data=wine) + geom_point(alpha=1/4)
```

```{r echo=FALSE, message=FALSE, warning=FALSE}
# create scatter plot of pH vs. log(fixed acidity)
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# create scatter plot of pH vs. citric acid
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# create scatter plot of density vs. alcohol content
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# create scatter plot of density vs. fixed acidity
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# create density plot of quality by alcohol bucket
ggplot(aes(x=quality), data = wine) + 
  ...
  theme(panel.background = element_rect(fill='gray'), 
      panel.grid.major = element_line(color='#969393'), 
      panel.grid.minor = element_line(color='#969393'))
```

From the density plot above, we can see that high-alcohol wines tend to occur most often at high quality ratings (6 or higher) low-alcohol wines tend to occur most often at low quality ratings (5 or below).

```{r echo=FALSE, message=FALSE, warning=FALSE}
# create line graph of median volatile acidity vs. quality by alcohol bucket
...
# create scatter plot of quality by volatile acidity and alcohol bucket
p2 <- ggplot(aes(x=volatile.acidity, y=quality), data = wine) + 
        geom_jitter(aes(color=alcohol.bucket)) +
        scale_color_brewer(palette='Greens', 
            guide = guide_legend(title = 'Percent Alcohol', reverse = T, 
            override.aes = list(alpha = 1, size = 2))) + 
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# create density plot of quality by volatile acidity bucket
ggplot(aes(x=quality), data = wine) + 
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# create line graph of median alcohol vs. quality by volatile acidity bucket
...
# create scatter plot of quality by alcohol and volatile acidity bucket
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# plot boxplot of volatile acidity to alcohol ratio by quality factor
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# create boxplot of citric acid to fixed acidity ratio by quality factor
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# create boxplot of sulphates to chlorides ratio
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# create scatter plot of alcohol vs. volatile acidity colored by quality
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# create scatter plot of citric acid vs. volatile acidity colored by quality
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# now facet wrap the scatter plot over alcohol bucket
ggplot(aes(x=volatile.acidity, y=citric.acid), data=wine) +
  geom_point(aes(color=quality.factor)) +
  scale_color_brewer(palette='Blues',
      guide = guide_legend(title = 'Quality', reverse = T,
...
# get random sample of wine from dataset
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# select wine with quality rating of 8
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# select wine with quality rating of 3
...
# create polished density plot of quality by alcohol bucket
...
# create polished scatter plot of quality by volatile acidity and alcohol bucket
p2 <- ggplot(aes(x=volatile.acidity, y=quality), data = wine) + 
        geom_jitter(aes(color=alcohol.bucket)) +
        scale_color_brewer(palette='Greens', guide = FALSE) +
        theme(plot.title = element_text(hjust = 0.5), 
            panel.background = element_rect(fill='gray'), 
            panel.grid.major = element_line(color='#969393'), 
            panel.grid.minor = element_line(color='#969393')) +
...
# create polished density plot of quality by volatile acidity bucket
p1 <- ggplot(aes(x=quality), data = wine) + 
        geom_density(aes(color=volatile.acidity.bucket)) +
        scale_color_brewer(palette='Purples',
...
# create polished scatter plot of quality by aolcohol and volatile acidity bucket
p2 <- ggplot(aes(x=alcohol, y=quality), data = wine) + 
        geom_jitter(aes(color=volatile.acidity.bucket)) +
        scale_color_brewer(palette='Purples', guide = FALSE) +
        theme(plot.title = element_text(hjust = 0.5), 
            panel.background = element_rect(fill='gray'), 
            panel.grid.major = element_line(color='#969393'), 
            panel.grid.minor = element_line(color='#969393')) +
...
# create polished boxplot of sulphates to chlorides ratio by quality factor
