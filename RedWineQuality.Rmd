...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# plot high quality vs low quality histograms
p1 <- qplot(x = residual.sugar, data = high_quality) + 
        scale_x_log10()

p2 <- qplot(x = residual.sugar, data = low_quality) + 
        scale_x_log10()

p3 <- qplot(x = chlorides, data = high_quality) + 
        scale_x_log10()

p4 <- qplot(x = chlorides, data = low_quality) + 
        scale_x_log10()
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# plot high quality vs low quality histograms
p1 <- qplot(x = free.sulfur.dioxide, data = high_quality) + 
        scale_x_log10()

p2 <- qplot(x = free.sulfur.dioxide, data = low_quality) + 
        scale_x_log10()

p3 <- qplot(x = total.sulfur.dioxide, data = high_quality) + 
        scale_x_log10()

p4 <- qplot(x = total.sulfur.dioxide, data = low_quality) + 
        scale_x_log10()

p5 <- qplot(x = sulphates, data = high_quality) + 
        scale_x_log10()

p6 <- qplot(x = sulphates, data = low_quality) + 
        scale_x_log10()
...
ggplot(aes(x = quality), data = wine) + 
  ...
  scale_color_brewer(palette= 'Greens',
                     guide = guide_legend(title = 'Percent Alcohol', 
                                          reverse = T, 
                                          override.aes = list(alpha = 1, 
                                                              size = 2))) +
  theme(panel.background = element_rect(fill = 'gray'), 
...
ggplot(aes(x = quality.factor, y = sulphates), 
       data = subset(wine, sulphates < 1.5)) +
...
# create boxplot of sulphates to chlorides ratio by quality factor
