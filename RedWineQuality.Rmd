...
Additionally, from plotting the ratio of sulphates to chlorides, I can see a more dramatic, more linear relationship with quality than the plot with sulphates alone. This ratio is often said to be important for beer-brewing, so it's interesting that it appears to have an effect here as well. 
